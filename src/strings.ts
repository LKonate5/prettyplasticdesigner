...
export const STR = {
  ...
  streetAndNumber: 'Street name + number',
  ...
  sampleColoursPerProductHint: 'Select up to 3 colours/shades for this product.',
  ...
  sampleLeadRequired:
    'Please fill in the delivery address and select at least one product with 1 to 3 colours/shades.',
